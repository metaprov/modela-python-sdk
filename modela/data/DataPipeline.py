...
class DataPipeline(Resource):
    def __init__(self, item: MDDataPipeline = MDDataPipeline(), client=None, namespace="", name=""):
...
class DataPipelineClient:
    ...
    def get(self, namespace: str, name: str) -> Union[DataPipeline, bool]:
        ...
        try:
            ...
            return DataPipeline(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[DataPipeline], bool]:
        ...
        try:
            ...
            return [DataPipeline(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
