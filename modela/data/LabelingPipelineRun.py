...
class LabelingPipelineRun(Resource):
    def __init__(self, item: MDLabelingPipelineRun = MDLabelingPipelineRun(), client=None, namespace="", name=""):
...
class LabelingPipelineRunClient:
    ...
    def create(self, labelingpipelinerun: LabelingPipelineRun) -> bool:
        ...
        request.item.CopyFrom(LabelingPipelineRun.raw_message)
        try:
    ...
    def update(self, labelingpipelinerun: LabelingPipelineRun) -> bool:
        ...
        request.item = LabelingPipelineRun.raw_message
        try:
    ...
    def get(self, namespace: str, name: str) -> Union[LabelingPipelineRun, bool]:
        ...
        try:
            ...
            return LabelingPipelineRun(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[LabelingPipelineRun], bool]:
        ...
        try:
            ...
            return [LabelingPipelineRun(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
