...
class WebRequest(Resource):
    def __init__(self, item: MDWebRequest = MDWebRequest(), client=None, namespace="", name=""):
...
class WebRequestClient:
    ...
    def create(self, webrequest: WebRequest) -> bool:
        ...
        request.item.CopyFrom(WebRequest.raw_message)
        try:
    ...
    def update(self, webrequest: WebRequest) -> bool:
        ...
        request.item = WebRequest.raw_message
        try:
    ...
    def get(self, namespace: str, name: str) -> Union[WebRequest, bool]:
        ...
        try:
            ...
            return WebRequest(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[WebRequest], bool]:
        ...
        try:
            ...
            return [WebRequest(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
