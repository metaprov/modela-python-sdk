...
@datamodel(proto=data_pb.MultiDatasetTest)
class MultiDatasetTest(Configuration):
    """ MultiDatasetTestName specifies a test between multiple datasets """
    Type: MultiDatasetTestName = None
    """ The type of test """
    Datasets: List[str] = field(default_factory=lambda : [])
    """ The list of datasets that will be checked """
    Generated: bool = False
    """ Indicates if this test was automatically generated by the system """


@datamodel(proto=data_pb.DatasetTest)
class DatasetTest(Configuration):
    """ DatasetTestName specifies a test for the contents of an entire dataset """
    Type: DatasetTestName = None
    """ The type of test """
    Value: float = 0
    Min: float = 0
    Max: float = 0
...
@datamodel(proto=data_pb.MultiColumnTest)
class MultiColumnTest(Configuration):
    """ MultiColumnTest specifies a test that encompasses multiple columns """
    Type: MultiColumnTestName = None
    """ The type of test  """
...
@datamodel(proto=data_pb.ColumnTest)
class ColumnTest(Configuration):
    """ ColumnTest specifies a test rule for a single column """
    Type: ColumnTestName = None
    """ The type of test """
    Column: str = ''
...
@datamodel(proto=data_pb.FileTest)
class FileTest(Configuration):
    Type: FileTestName = None
    BucketName: str = ''
    Column: str = ''
    Value: float = 0
    """ For tests that need a single value """
    Min: float = 0
    Max: float = 0
    ValueSet: List[str] = field(default_factory=lambda : [])
    StrictMin: bool = False
    StrictMax: bool = False
    Generated: bool = False
    """ Generated indicate weather this test was automatically generated """


@datamodel(proto=data_pb.TestSpec)
class Tests(Configuration):
    MultiDatasetTests: List[MultiDatasetTest] = field(default_factory=lambda : [])
    DatasetTests: List[DatasetTest] = field(default_factory=lambda : [])
    """ DatasetTests contains tests for the whole dataset """
    MultiColumnTests: List[MultiColumnTest] = field(default_factory=lambda : [])
    """ MultiColumnTests defines tests for multiple columns from the dataset """
    ColumnTests: List[ColumnTest] = field(default_factory=lambda : [])
    """ ColumnTests defines assertions for columns from the dataset """
    FileTests: List[FileTest] = field(default_factory=lambda : [])
...
@datamodel(proto=data_pb.DataTestResult)
class DataTestResult(Configuration):
    Type: str = ''
    Column: str = ''
    Error: str = ''
    Passed: bool = False
...
class DatasetStatus(ImmutableConfiguration):
    ...
    TestResults: List[DataTestResult] = field(default_factory=lambda : [])
