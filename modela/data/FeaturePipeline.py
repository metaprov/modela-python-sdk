...
class FeaturePipeline(Resource):
    def __init__(self, item: MDFeaturePipeline = MDFeaturePipeline(), client=None, namespace="", name=""):
...
class FeaturePipelineClient:
    ...
    def get(self, namespace: str, name: str) -> Union[FeaturePipeline, bool]:
        ...
        try:
            ...
            return FeaturePipeline(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[FeaturePipeline], bool]:
        ...
        try:
            ...
            return [FeaturePipeline(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
