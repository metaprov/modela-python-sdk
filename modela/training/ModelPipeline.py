...
class ModelPipeline(Resource):
    def __init__(self, item: MDModelPipeline = MDModelPipeline(), client=None, namespace="", name=""):
...
class ModelPipelineClient:
    ...
    def create(self, modelpipeline: ModelPipeline) -> bool:
        ...
        request.item.CopyFrom(ModelPipeline.raw_message)
        try:
    ...
    def update(self, modelpipeline: ModelPipeline) -> bool:
        ...
        request.item = ModelPipeline.raw_message
        try:
    ...
    def get(self, namespace: str, name: str) -> Union[ModelPipeline, bool]:
        ...
        try:
            ...
            return ModelPipeline(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[ModelPipeline], bool]:
        ...
        try:
            ...
            return [ModelPipeline(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
