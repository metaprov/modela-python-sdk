...
class Prediction(Resource):
    def __init__(self, item: MDPrediction = MDPrediction(), client=None, namespace="", name=""):
...
class PredictionClient:
    ...
    def get(self, namespace: str, name: str) -> Union[Prediction, bool]:
        ...
        try:
            ...
            return Prediction(response.item, self)
        except grpc.RpcError as err:
            error = err
    ...
    def list(self, namespace: str) -> Union[List[Prediction], bool]:
        ...
        try:
            ...
            return [Prediction(item, self) for item in response.items.items]
        except grpc.RpcError as err:
            error = err
